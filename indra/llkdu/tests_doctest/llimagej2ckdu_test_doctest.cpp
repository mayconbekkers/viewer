...
TUT_SUITE("LLImageJ2CKDU")
{
    TUT_CASE("LLImageJ2CKDU::llimagej2ckdu_object_t_test_1")
    {
        using namespace tut;
        llimagej2ckdu_test data;
        auto* mImage = data.mImage;
    ...
    TUT_CASE("LLImageJ2CKDU::llimagej2ckdu_object_t_test_2")
    {
        using namespace tut;
        llimagej2ckdu_test data;
        auto* mImage = data.mImage;
    ...
    TUT_CASE("LLImageJ2CKDU::llimagej2ckdu_object_t_test_3")
    {
        using namespace tut;
        llimagej2ckdu_test data;
        auto* mImage = data.mImage;
