// ---------------------------------------------------------------------------
// Auto-generated from v4coloru_test.cpp at 2025-10-17T12:56:18+00:00
...
TUT_SUITE("v4coloru_test")
{
    TUT_CASE("v4coloru_test::v4coloru_object_test_1")
    {
        using namespace tut;
        LLColor4U llcolor4u;
        TUT_CHECK_MSG(((0 == llcolor4u.mV[VRED]) && (0 == llcolor4u.mV[VGREEN]) && (0 == llcolor4u.mV[VBLUE])&& (255 == llcolor4u.mV[VALPHA])), "1:LLColor4u:Fail to initialize ");

        U8 r = 0x12, g = 0xFF, b = 0xAF, a = 0x23;
        LLColor4U llcolor4u1(r,g,b);
        TUT_CHECK_MSG(((r == llcolor4u1.mV[VRED]) && (g == llcolor4u1.mV[VGREEN]) && (b == llcolor4u1.mV[VBLUE])&& (255 == llcolor4u1.mV[VALPHA])), "2:LLColor4u:Fail to initialize ");

        LLColor4U llcolor4u2(r,g,b,a);
        TUT_CHECK_MSG(((r == llcolor4u2.mV[VRED]) && (g == llcolor4u2.mV[VGREEN]) && (b == llcolor4u2.mV[VBLUE])&& (a == llcolor4u2.mV[VALPHA])), "3:LLColor4u:Fail to initialize ");

        const U8 vec[4] = {0x12,0xFF,0xAF,0x23};
        LLColor4U llcolor4u3(vec);
        TUT_CHECK_MSG(((vec[0] == llcolor4u3.mV[VRED]) && (vec[1] == llcolor4u3.mV[VGREEN]) && (vec[2] == llcolor4u3.mV[VBLUE])&& (vec[3] == llcolor4u3.mV[VALPHA])), "4:LLColor4u:Fail to initialize ");
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_3")
    {
        ...
        TUT_CHECK_MSG(((0 == llcolor4u.mV[VRED]) && (0 == llcolor4u.mV[VGREEN]) && (0 == llcolor4u.mV[VBLUE])&& (255 == llcolor4u.mV[VALPHA])), "setToBlack:Fail to set black ");

        llcolor4u.setToWhite();
        TUT_CHECK_MSG(((255 == llcolor4u.mV[VRED]) && (255 == llcolor4u.mV[VGREEN]) && (255 == llcolor4u.mV[VBLUE])&& (255 == llcolor4u.mV[VALPHA])), "setToWhite:Fail to white ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_5")
    {
        ...
        TUT_CHECK_MSG(((r == llcolor4u.mV[VRED]) && (g == llcolor4u.mV[VGREEN]) && (b == llcolor4u.mV[VBLUE])&& (a == llcolor4u.mV[VALPHA])), "1:setVec:Fail to set the values ");

        llcolor4u.setToBlack();
        llcolor4u.setVec(r,g,b);
        TUT_CHECK_MSG(((r == llcolor4u.mV[VRED]) && (g == llcolor4u.mV[VGREEN]) && (b == llcolor4u.mV[VBLUE])&& (255 == llcolor4u.mV[VALPHA])), "2:setVec:Fail to set the values ");
        ...
        TUT_CHECK_MSG(((vec[0] == llcolor4u2.mV[VRED]) && (vec[1] == llcolor4u2.mV[VGREEN]) && (vec[2] == llcolor4u2.mV[VBLUE])&& (vec[3] == llcolor4u2.mV[VALPHA])), "4:setVec:Fail to set the values ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_6")
    {
        ...
        TUT_CHECK_MSG((alpha == llcolor4u.mV[VALPHA]), "setAlpha:Fail to set alpha value ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_7")
    {
        ...
        TUT_CHECK_MSG(is_approx_equal(llcolor4u.magVecSquared(), (F32)(r*r + g*g + b*b)), "magVecSquared:Fail ");
        TUT_CHECK_MSG(is_approx_equal(llcolor4u.magVec(), (F32) sqrt((F32) (r*r + g*g + b*b))), "magVec:Fail ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_12")
    {
        ...
        TUT_CHECK_MSG((llcolor4u1 == llcolor4u), "operator== failed to ensure the equality ");
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_14")
    {
        ...
        TUT_CHECK_MSG(((12 == llcolor4u1.mV[VRED]) && (23 == llcolor4u1.mV[VGREEN]) && (132 == llcolor4u1.mV[VBLUE])&& (50 == llcolor4u1.mV[VALPHA])), "parseColor4U() failed to parse the color value ");

        color = "12, 23, 132";
        TUT_CHECK_MSG((false == LLColor4U::parseColor4U(color, &llcolor4u1)), "2:parseColor4U() failed to parse the color value ");
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_15")
    {
        ...
        TUT_CHECK_MSG((((U8)ll_round(r * fVal) == llcolor4u1.mV[VRED]) && (U8)ll_round(g * fVal) == llcolor4u1.mV[VGREEN]
                                            && ((U8)ll_round(b * fVal) == llcolor4u1.mV[VBLUE])&& ((U8)ll_round(a * fVal) == llcolor4u1.mV[VALPHA])), "multAll:Fail to multiply ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_16")
    {
        ...
        TUT_CHECK_MSG(((r1+r2 == llcolor4u1.mV[VRED]) && (255 == llcolor4u1.mV[VGREEN]) && (b1+b2 == llcolor4u1.mV[VBLUE])&& (255 == llcolor4u1.mV[VALPHA])), "1:addClampMax():Fail to add the value ");
        ...
        TUT_CHECK_MSG(((255 == llcolor4u3.mV[VRED]) && (g1+g2 == llcolor4u3.mV[VGREEN]) && (b1+b2 == llcolor4u3.mV[VBLUE])&& (a1+a2 == llcolor4u3.mV[VALPHA])), "2:addClampMax():Fail to add the value ");
    }
    ...
    TUT_CASE("v4coloru_test::v4coloru_object_test_17")
    {
        ...
        TUT_CHECK_MSG(((r2 == llcolor4u.mV[VRED]) && (g2 == llcolor4u.mV[VGREEN]) && (0 == llcolor4u.mV[VBLUE])&& (255 == llcolor4u.mV[VALPHA])), "setVecScaleClamp():Fail to add the value ");
    }
}
