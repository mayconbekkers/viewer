// ---------------------------------------------------------------------------
// Auto-generated from llrect_test.cpp at 2025-10-17T12:56:17+00:00
...
TUT_SUITE("llrect_test")
{
    TUT_CASE("llrect_test::object_test_1")
    {
        ...
        // default constructor
        LLRect rect1;
        TUT_ENSURE_EQ("Empty rect", rect1.getValue(), zero);
    ...
    TUT_CASE("llrect_test::object_test_2")
    {
        ...
        LLRectf rect2;
        TUT_ENSURE_EQ("Empty rectf", rect2.getValue(), zerof);
    ...
    TUT_CASE("llrect_test::object_test_12")
    {
        ...
        TUT_CHECK_MSG(rectf.isValid(), "BBox is valid");

        rectf.mLeft = 2.0f;
        TUT_CHECK_MSG(! rectf.isValid(), "BBox is not valid");

        rectf.makeValid();
        TUT_CHECK_MSG(rectf.isValid(), "BBox forced valid");

        rectf.set(-1.0f, -1.0f, -1.0f, -1.0f);
        TUT_CHECK_MSG(rectf.isValid(), "BBox(0,0,0,0) is valid");
    }
    ...
    TUT_CASE("llrect_test::object_test_13")
    {
        ...
        rectf.set(-1.0f, 1.0f, 1.0f, -1.0f);
        TUT_CHECK_MSG(! rectf.isEmpty(), "BBox is not Null");
        TUT_CHECK_MSG(rectf.notEmpty(), "BBox notNull");

        rectf.mLeft = 2.0f;
        rectf.makeValid();
        TUT_CHECK_MSG(rectf.isEmpty(), "BBox is now Null");

        rectf.set(-1.0f, -1.0f, -1.0f, -1.0f);
        TUT_CHECK_MSG(rectf.isEmpty(), "BBox(0,0,0,0) is Null");
    }
    ...
    TUT_CASE("llrect_test::object_test_14")
    {
        ...
        TUT_CHECK_MSG(! (rect1 == rect2), "rect1 == rect2 (false)");
        TUT_CHECK_MSG(rect1 != rect2, "rect1 != rect2 (true)");

        TUT_CHECK_MSG(rect1 == rect1, "rect1 == rect1 (true)");
        TUT_CHECK_MSG(! (rect1 != rect1), "rect1 != rect1 (false)");
    }
    ...
    TUT_CASE("llrect_test::object_test_16")
    {
        ...
        TUT_CHECK_MSG(rect1 == rect2, "translate(0, 0)");

        rect1.translate(100.0f, 100.0f);
        rect1.translate(-100.0f, -100.0f);

        TUT_CHECK_MSG(rect1 == rect2, "translate(100, 100) + translate(-100, -100)");

        rect1.translate(10.0f, 0.0f);
        rect2.set(9.0f, 1.0f, 11.0f, -1.0f);
        TUT_CHECK_MSG(rect1 == rect2, "translate(10, 0)");

        rect1.translate(0.0f, 10.0f);
        rect2.set(9.0f, 11.0f, 11.0f, 9.0f);
        TUT_CHECK_MSG(rect1 == rect2, "translate(0, 10)");

        rect1.translate(-10.0f, -10.0f);
        rect2.set(-1.0f, 1.0f, 1.0f, -1.0f);
        TUT_CHECK_MSG(rect1 == rect2, "translate(-10, -10)");
    }
    ...
    TUT_CASE("llrect_test::object_test_17")
    {
        ...
        rect1.stretch(0.0f);
        TUT_CHECK_MSG(rect1 == rect2, "stretch(0)");

        rect1.stretch(0.0f, 0.0f);
        TUT_CHECK_MSG(rect1 == rect2, "stretch(0, 0)");

        rect1.stretch(10.0f);
        rect1.stretch(-10.0f);
        TUT_CHECK_MSG(rect1 == rect2, "stretch(10) + stretch(-10)");

        rect1.stretch(2.0f, 1.0f);
        rect2.set(-3.0f, 2.0f, 3.0f, -2.0f);
        TUT_CHECK_MSG(rect1 == rect2, "stretch(2, 1)");
    }
    ...
    TUT_CASE("llrect_test::object_test_19")
    {
        ...
        rect3 = rect1;
        rect3.intersectWith(rect2);
        TUT_CHECK_MSG(rect3.isEmpty(), "intersect - no overlap");
    }
    ...
    TUT_CASE("llrect_test::object_test_20")
    {
        ...
        TUT_CHECK_MSG(rect.pointInRect(0.0f, 0.0f) == false, "(0,0) not in rect");
        TUT_CHECK_MSG(rect.pointInRect(2.0f, 2.0f) == true, "(2,2) in rect");
        TUT_CHECK_MSG(rect.pointInRect(1.0f, 1.0f) == true, "(1,1) in rect");
        TUT_CHECK_MSG(rect.pointInRect(3.0f, 3.0f) == false, "(3,3) not in rect");
        TUT_CHECK_MSG(rect.pointInRect(2.999f, 2.999f) == true, "(2.999,2.999) in rect");
        TUT_CHECK_MSG(rect.pointInRect(2.999f, 3.0f) == false, "(2.999,3.0) not in rect");
        TUT_CHECK_MSG(rect.pointInRect(3.0f, 2.999f) == false, "(3.0,2.999) not in rect");
    }
    ...
    TUT_CASE("llrect_test::object_test_21")
    {
        ...
        TUT_CHECK_MSG(rect.localPointInRect(0.0f, 0.0f) == true, "(0,0) in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(-0.0001f, -0.001f) == false, "(-0.0001,-0.0001) not in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(1.0f, 1.0f) == true, "(1,1) in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(2.0f, 2.0f) == false, "(2,2) not in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(1.999f, 1.999f) == true, "(1.999,1.999) in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(1.999f, 2.0f) == false, "(1.999,2.0) not in local rect");
        TUT_CHECK_MSG(rect.localPointInRect(2.0f, 1.999f) == false, "(2.0,1.999) not in local rect");
    }
