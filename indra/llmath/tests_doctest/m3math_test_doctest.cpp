// ---------------------------------------------------------------------------
// Auto-generated from m3math_test.cpp at 2025-10-17T12:56:17+00:00
...
TUT_SUITE("m3math_test")
{
    TUT_CASE("m3math_test::m3math_test_object_t_test_1")
    {
        ...
        TUT_CHECK_MSG(1.f == llmat3_obj.mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_2")
    {
        ...
        TUT_CHECK_MSG(0.f == llmat3_obj.setZero().mMatrix[0][0] &&
                    ...
                    0.f == llmat3_obj.setZero().mMatrix[2][2], "LLMatrix3::setZero failed");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_3")
    {
        ...
        TUT_CHECK_MSG(2 == llmat3_obj.mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_4")
    {
        ...
        TUT_CHECK_MSG(vect1 == llmat3_obj.getFwdRow(), "LLVector3::getFwdRow failed ");
        TUT_CHECK_MSG(vect2 == llmat3_obj.getLeftRow(), "LLVector3::getLeftRow failed ");
        TUT_CHECK_MSG(vect3 == llmat3_obj.getUpRow(), "LLVector3::getUpRow failed ");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_5")
    {
        ...
        TUT_CHECK_MSG(50 == llmat_obj3.mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_6")
    {
        ...
        TUT_CHECK_MSG(res_vec == expected_result, "LLMatrix3::operator*(const LLVector3 &a, const LLMatrix3 &b) failed");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_7")
    {
        ...
        TUT_CHECK_MSG(llvec3d1 == expected_result, "LLMatrix3::operator*(const LLVector3 &a, const LLMatrix3 &b) failed");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_8")
    {
        ...
        TUT_CHECK_MSG(llmat_obj1 == llmat_obj2, "LLMatrix3::operator==(const LLMatrix3 &a, const LLMatrix3 &b) failed");
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_9")
    {
        ...
        TUT_CHECK_MSG(is_approx_equal(-0.66666669f, llmat_quat.mQ[0]) &&
                        is_approx_equal(-0.83333337f, llmat_quat.mQ[1]) &&
                        is_approx_equal(0.0f, llmat_quat.mQ[2]) &&
                        is_approx_equal(1.5f, llmat_quat.mQ[3]), "LLMatrix3::quaternion failed ");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_10")
    {
        ...
        TUT_CHECK_MSG(llmat_obj == expectedllmat_obj, "LLMatrix3::transpose failed ");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_11")
    {
        ...
        LLVector3 llvec3(2, 2, 2);
        llmat_obj1.setRows(llvec1, llvec2, llvec3);
        TUT_CHECK_MSG(0.0f == llmat_obj1.determinant(), "LLMatrix3::determinant failed ");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_12")
    {
        ...
        TUT_SKIP("This test fails depending on architecture. Need to fix comparison operation, is_approx_equal, to work on more than one platform.");

        llmat_obj.setRows(llvec1, llvec2, llvec3);
        llmat_obj.orthogonalize();

        TUT_CHECK_MSG(is_approx_equal(0.19611614f, llmat_obj.mMatrix[0][0]) &&
               ...
               is_approx_equal(-0.28571429f, llmat_obj.mMatrix[2][2]), "LLMatrix3::orthogonalize failed ");
    }
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_13")
    {
        ...
        TUT_CHECK_MSG(10 == llmat_obj.mMatrix[0][0] &&
