// ---------------------------------------------------------------------------
// Auto-generated from llbbox_test.cpp at 2025-10-17T12:56:17+00:00
...
{
    TUT_CASE("llbbox_test::object_test_1")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_2")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_3")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_4")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_5")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_6")
    {
        using namespace tut;
        //
        ...
        TUT_CHECK_MSG(APPROX_EQUAL(bbox2.getCenterAgent(), LLVector3(-2.0f, 4.0f, 4.0f)), "Custom bbox center agent with rot");
    }

    TUT_CASE("llbbox_test::object_test_7")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_8")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_9")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_10")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_11")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_12")
    {
        using namespace tut;
        //
    ...
    TUT_CASE("llbbox_test::object_test_13")
    {
        using namespace tut;
        //
        ...
        TUT_CHECK_MSG(APPROX_EQUAL(bbox2.localToAgent(LLVector3(1.0f, 2.0f, 3.0f)), LLVector3(2.0f, -2.0f, 3.0f)), "localToAgent(1,2,3) rot");
    }

    TUT_CASE("llbbox_test::object_test_14")
    {
        using namespace tut;
        //
        ...
        TUT_ENSURE_EQ("agentToLocal(localToAgent)", bbox1.agentToLocal(bbox1.localToAgent(LLVector3(1.0f, 2.0f, 3.0f))), LLVector3(1.0f, 2.0f, 3.0f));

        LLBBox bbox2(LLVector3(1.0f, 1.0f, 1.0f), LLQuaternion(ANGLE, LLVector3(1.0f, 0.0f, 0.0f)),
                     LLVector3(1.0f, 1.0f, 1.0f), LLVector3(3.0f, 3.0f, 3.0f));

        TUT_CHECK_MSG(APPROX_EQUAL(bbox2.agentToLocal(LLVector3(1.0f, 2.0f, 3.0f)), LLVector3(0.0f, 2.0f, -1.0f)), "agentToLocal(1,2,3) rot");
        TUT_CHECK_MSG(APPROX_EQUAL(bbox2.agentToLocal(bbox2.localToAgent(LLVector3(1.0f, 2.0f, 3.0f))),
                                                              LLVector3(1.0f, 2.0f, 3.0f)), "agentToLocal(localToAgent) rot");
    }

    TUT_CASE("llbbox_test::object_test_15")
    {
        using namespace tut;
        //
        ...
        TUT_CHECK_MSG(bbox1.containsPointLocal(LLVector3(0.0f, 0.0f, 0.0f)) == false, "containsPointLocal(0,0,0)");
        TUT_CHECK_MSG(bbox1.containsPointLocal(LLVector3(1.0f, 2.0f, 3.0f)) == true, "containsPointLocal(1,2,3)");
        TUT_CHECK_MSG(bbox1.containsPointLocal(LLVector3(0.999f, 2.0f, 3.0f)) == false, "containsPointLocal(0.999,2,3)");
        TUT_CHECK_MSG(bbox1.containsPointLocal(LLVector3(3.0f, 4.0f, 5.0f)) == true, "containsPointLocal(3,4,5)");
        TUT_CHECK_MSG(bbox1.containsPointLocal(LLVector3(3.0f, 4.0f, 5.001f)) == false, "containsPointLocal(3,4,5.001)");
    }

    TUT_CASE("llbbox_test::object_test_16")
    {
        using namespace tut;
        //
        ...
        TUT_CHECK_MSG(bbox1.containsPointAgent(LLVector3(0.0f, 0.0f, 0.0f)) == false, "containsPointAgent(0,0,0)");
        TUT_CHECK_MSG(bbox1.containsPointAgent(LLVector3(2.0f, 3.0f, 4.0f)) == true, "containsPointAgent(2,3,4)");
        TUT_CHECK_MSG(bbox1.containsPointAgent(LLVector3(2.0f, 2.999f, 4.0f)) == false, "containsPointAgent(2,2.999,4)");
        TUT_CHECK_MSG(bbox1.containsPointAgent(LLVector3(4.0f, 5.0f, 6.0f)) == true, "containsPointAgent(4,5,6)");
        TUT_CHECK_MSG(bbox1.containsPointAgent(LLVector3(4.0f, 5.001f, 6.0f)) == false, "containsPointAgent(4,5.001,6)");
    }
}
