// ---------------------------------------------------------------------------
// Auto-generated from llexception_test.cpp at 2025-10-16T20:37:40+00:00
...
TUT_SUITE("llexception")
{
    TUT_CASE("llexception_test::throwing exceptions")
    {
        using namespace tut;
        TUT_SET_TEST_NAME("throwing exceptions");
    ...
    TUT_CASE("llexception_test::reporting exceptions")
    {
        using namespace tut;
        TUT_SET_TEST_NAME("reporting exceptions");
